...
* `--sda` and `--scl` options to specify the gpio number used by I2C bus, here we choose GPIO7 as the SDA and GPIO8 as the SCL, matching the shared I2C1 bus of the ESP32-P4-WIFI6-DB.
