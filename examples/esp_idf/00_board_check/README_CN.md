...
如果你的开发板使用早于 rev v3.0 的 ESP32-P4 早期工程样片，或者需要把量产构建固定到 rev v3.0/v3.1，请在烧录前通过 `idf.py menuconfig` → Component config → Hardware Settings → Chip revision 设置芯片版本的最小和最大值。
...
- 运行 [01_gpio_input](../01_gpio_input/)，点亮显示屏。
- 如果想扫描 I2C 设备，运行 [02_i2c_console](../02_i2c_console/)。
- 阅读仓库根目录的 [README](../../../README_CN.md)，为你的开发板选择下一个示例。
